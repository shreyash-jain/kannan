...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-black/5 bg-cream/85 backdrop-blur supports-[backdrop-filter]:bg-cream/70">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-6 px-5 py-4 lg:px-8">
        ...
        >
          <span className="font-display text-2xl tracking-tight text-bush-deep">
            Kanaan
          </span>
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="hidden rounded-full bg-bush px-4 py-2 text-sm font-medium text-cream transition-colors hover:bg-bush-deep sm:inline-block"
          >
            Book on WhatsApp
          </a>
          <button
      ...
      {open && (
        <nav
          aria-label="Mobile"
          className="border-t border-black/5 bg-cream lg:hidden"
        >
          <ul className="mx-auto flex max-w-7xl flex-col px-5 py-3">
            {nav.map((n) => (
              <li key={n.href}>
                <Link
                  ...
                  className="block py-2.5 text-base font-medium text-ink/85 hover:text-clay"
                >
                  {n.label}
                </Link>
              </li>
            ...
            <li className="pt-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block rounded-full bg-bush px-4 py-2 text-sm font-medium text-cream"
              >
                Book on WhatsApp
              </a>
            </li>
