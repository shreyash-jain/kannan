...
export function Footer() {
  return (
    <footer className="mt-24 border-t border-black/5 bg-forest-deep text-bone">
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-14 md:grid-cols-4 lg:px-8">
        <div className="md:col-span-2">
          ...
          <p className="mt-3 max-w-md text-bone/80">{site.tagline}</p>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm">
            {nav.map((n) => (
              <li key={n.href}>
                <Link href={n.href} className="hover:text-ochre">
                  {n.label}
                </Link>
              </li>
            ))}
      ...
      <div className="border-t border-bone/10">
        <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-3 px-5 py-5 text-xs text-bone/60 md:flex-row md:items-center lg:px-8">
          <p>
